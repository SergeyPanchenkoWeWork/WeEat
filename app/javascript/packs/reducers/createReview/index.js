...
export default createReducer({
    [ACTIONS_NAME.CREATE_REVIEW_CLEAR]: (state, action) => (initState),
    [ACTIONS_NAME.CREATE_REVIEW_STARTED]: (state, action) => {
        return {
            ...state,
    ...
    [ACTIONS_NAME.CREATE_REVIEW_FAILED]: (state, action) => {
    ...
    [ACTIONS_NAME.CREATE_REVIEW_DONE]: (state, action) => {
        if (state.paramsHash !== action.paramsHash) {
            return state;
        }
